...
- インフラ構成～アプリ開発までの全技術についての知識を網羅
  - クライアント・サーバーシステムの全体像の知識をある程度カバーしており、全体アーキテクトが可能
  - 作りたいモノの規模をお客様からヒアリングを行い、適切予算内で最適解を出すように、提案できる
- 新しくて美しいコードの追求
...
- ビジネスを学んでいる
  ...
  - ビジネスフレームワークについても学んでおり、ソフトウェア工学とミックスして、戦略的なソフトウェア開発を目指している
  - ビジネス分析手法についても、実際のソフトウェア戦略にて実践している。
- 言語経験が豊富
  - 利用言語が多く、言語の良し悪しを判断した技術採択が可能
  - また、新たな言語が出るごとに、書き方やもっている機能を見て、プロダクト最適か判断できる
- 技術検証の決断の速度感・未来世を重視する
  - 言語経験が豊富でかつ、自分で手を動かして検証し、チーム全体で利用可能かどうかの検証が早い
  - ビジネス・チームの習熟度をみて、技術的な未来世以外の変数も考慮して、技術検証を行う
- 顧客、経営層に対して寄り添った提案
  - 上記のとおり、ビジネス基礎知識はあるため、経営者層・顧客に対して、寄り添った提案が可能
  - 必要に応じて、文書の提出・プレゼンの実施などの実施も可能
- 大組織から、中小企業までの経験あり（従業員数3000～従業員数300名）
...
TimeTree非公式SDKの作成
- [pyTimeTree](https://github.com/m96-chan/pytimetree)
- PyPIにも登録済

## 情報収集

CTO・フリーランスとのコネクションがあり、定期的な情報交換を行う
勉強会などにも、定期的に定点で観測しており、新しいコミュニティに情報を集めにいく。
